package com.collection.example2;
...
public class Demo {
	public static void main(String[] args) {
		...
		Iterator<String> iterator = list.iterator();// only forwared direction
		...
		while (listIterator.hasNext())
			System.out.println("Value of element is: " + listIterator.next());// bi-directional
