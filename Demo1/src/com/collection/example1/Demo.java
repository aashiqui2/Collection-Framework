...
public class Demo {
	public static void main(String[] args) {
		...
		List<String> list2 = Arrays.asList("JavaScript", "C#", "Java");// return a fixed size list
		list2.set(0, "Ruby");// Modifying is possible
		//list2.remove(2);//java.lang.UnsupportedOperationException
		list.addAll(list2);
		System.out.println("Size of list is: " + list.size());
		System.out.println("Contents of list are: " + list);
